            ...
            <div className="notice-container2">
                ...
                <div className="notice-item">
                    <div className="notice-header" onClick={() => toggleCheck('preGuide')}>
                        <div
                            className={`check-box ${checkedItems.preGuide ? 'checked' : ''}`}
                        ></div>
                        <div>
                            <h3>회원가입 및 발급신청에 관한 필수 동의</h3>
                            <br />
                            <ul>
                                <li>
                ...
                <div className="notice-item">
                    <div className="notice-header" onClick={() => toggleCheck('fraudWarning')}>
                        <div
                            className={`check-box ${checkedItems.fraudWarning ? 'checked' : ''}`}
                        ></div>
                        <div className="notice-content">
                            <h3>실명 및 회원여부 확인 동의</h3>
                            <br />
                            <ul>
